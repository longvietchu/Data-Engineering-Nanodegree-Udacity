...
create_table_queries = [create_i94cit_res, create_i94port, create_i94mode, create_i94addr, create_i94visa, create_table_immigration, create_us_cities_demographics, create_airport_codes, create_world_temperature]